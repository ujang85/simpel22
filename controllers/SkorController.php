...
class SkorController extends Controller
{
    ...
    {    
        $searchModel = new SkorSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->andFilterWhere(['rumpun' => 'DOKTER']);
        return $this->render('indexdokter', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
    public function actionIndexperawat()
    {    
        $searchModel = new SkorSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->andFilterWhere(['rumpun' => 'PERAWAT']);
        return $this->render('indexperawat', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
    ...
    {    
        $searchModel = new SkorSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->andFilterWhere(['rumpun' => 'UMUM']);
        return $this->render('indexumum', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
    public function actionIndexkpkl()
    {    
        $searchModel = new SkorSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->andFilterWhere(['rumpun' => 'KPKL']);
        return $this->render('indexkpkl', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
